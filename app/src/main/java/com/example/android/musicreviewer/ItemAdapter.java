...
public class ItemAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Find the TextView in the list_item.xml layout with the ID item_text_view (main title).
        ...
        // Find the TextView in the list_item.xml layout with the ID sub_title_text_view.
